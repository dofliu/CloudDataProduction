...
全站為**深色工業風**(IBM Plex 字體 + 燈號摘要 + 門檻條),2.5D 世界為**等距金屬量體**(漸層立方體建築 + 發光機台),設計稿見 [docs/design_handoff_ui_redesign](docs/design_handoff_ui_redesign/)。
...
2.5D 工業區 + 產線編排 + 廠內人員、10 產業 template、multi_port、OEE 榜、資料集產生器、23 主題公司、
學生任務中心 + 個人化連線包、教師快速故障 / 重置課堂 / 真 LLM 建廠、學生可寫 setpoint、熱載入免重啟、
**前端 UI 全面重設計**(深色工業風 + IBM Plex 字體 + 等距金屬量體 2.5D 世界,見 [docs/design_handoff_ui_redesign](docs/design_handoff_ui_redesign/))。
