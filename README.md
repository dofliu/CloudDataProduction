...
- **8 產業 template**:CNC 加工中心 / 空壓機 / AGV / 機械手臂 / 射出成型機 / 風力機 /
  **半導體製程腔體** / **電表能源節點**(風機含風速—功率曲線、轉子轉速、齒輪箱退化等風能 SCADA 訊號;
  腔體含真空泵退化與製程漂移→良率的 subtle fault;電表含三相 V/I、功因、kWh 累積與日/週負載曲線)。
...
2.5D 工業區 + 產線編排 + 廠內人員、8 產業 template、multi_port、OEE 榜、資料集產生器、23 主題公司。
