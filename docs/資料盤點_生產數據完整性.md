...
> 盤點日期 2026-08-21(**P1 補完後同日重測**)· 對象 `scenarios/class_park.yaml`(69 廠 / 165 台 / 15 機型)
...
**P1 補完後(同日)**:停機原因碼、事件表、逐件生產紀錄與良/不良計數都進來了,
...
覆蓋率(P1 後):狀態 **165/165 台**、能耗 155/165 台、劣化徵兆 145/165 台、
產出計數 89/165 台、品質 **79/165 台**(補完前 39 台)。
